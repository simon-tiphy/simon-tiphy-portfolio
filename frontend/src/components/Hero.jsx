...
//               </span>
//             </h1>
//             <h2 className="text-2xl font-mono text-slate-500 mb-8 tracking-widest "> with <span className="text-pink-400 font-normal text-3xl">Simon Tiphy.</span></h2>
//             <p className="text-slate-400 text-lg md:text-xl max-w-lg leading-relaxed mb-8">
//               I build accessible, pixel-perfect, and performant web experiences. 
//               Currently focused on solving real-world problems in the Global Market.
//             </p>
...
//               <a href="https://github.com/simon-tiphy" target="_blank" rel="noreferrer" className="hover:text-white transition-colors"><Github size={24} /></a>
//               <a href="https://www.linkedin.com/in/simon-tiphy-77357130b/" target="_blank" rel="noreferrer" className="hover:text-blue-400 transition-colors"><Linkedin size={24} /></a>
//               <a href="https://x.com/SimonTiphy" target="_blank" rel="noreferrer" className="hover:text-white transition-colors"><svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"></path></svg></a>
//             </div>
//           </motion.div>
//         </div>
...
//                   <span className="text-pink-400">const</span> <span className="text-violet-400">developer</span> <span className="text-cyan-400">=</span> {'{'}
//                   <br />
//                   &nbsp;&nbsp;name: <span className="text-green-400">"Simon Tiphy"</span>,
//                   <br />
//                   &nbsp;&nbsp;role: <span className="text-green-400">"Full Stack Engineer"</span>,
//                   <br />
//                   &nbsp;&nbsp;location: <span className="text-green-400">"Nairobi, KE"</span>,
//                   <br />
//                   &nbsp;&nbsp;stack: [<span className="text-green-400">"React"</span>, <span className="text-green-400">"Python"</span>, <span className="text-green-400">"Next.js"</span>],
//                   <br />
//                   &nbsp;&nbsp;passion: <span className="text-green-400">"Building scalable systems"</span>,
//                   <br />
//                   &nbsp;&nbsp;problemSolver:true, <span className="text-green-400">"Problem solver"</span>,
//                   <br />
//                   &nbsp;&nbsp;quickLearner:true, <span className="text-green-400">"Quick learner"</span>,
//                   <br />
//                   &nbsp;&nbsp;hardWorker:true, <span className="text-green-400">"Hard worker"</span>,
//                   <br />
//                   &nbsp;&nbsp;status: <span className="text-green-400">"Hireable"</span>
//                   <br />
            ...
            <div className="p-6 font-mono text-sm leading-relaxed">
              <div className="flex">
                ...
                <div className="text-slate-300">
                  ...
                  &nbsp;&nbsp;status: <span className="text-green-400">"Hireable"</span>,
                  <br />
                  &nbsp;&nbsp;hireable:<span className="text-cyan-400">function</span>() {'{'}
                  <br />
